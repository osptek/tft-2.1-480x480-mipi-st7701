...
This repository holds materials for the **2.1″ 480×480 TFT (MIPI · ST7701)** module family.
...
Repo id: `2.1-tft-480x480-mipi-st7701`
...
| ------- | ----- | ------- | --------- |
| YDP210H003-V1 | <img alt="YDP210H003-V1" src="./versions/YDP210H003-V1/images/product.png" width="120" /> | [Summary](#ydp210h003-v1) | [Full docs](./versions/YDP210H003-V1/) |

---

## YDP210H003-V1

<p align="center"><img alt="YDP210H003-V1" src="./versions/YDP210H003-V1/images/product.png" width="320" /></p>

**Notes:** IPS; capacitive touch (I2C; touch IC not named in the datasheet).

Full product page, datasheets, and examples: [versions/YDP210H003-V1/](./versions/YDP210H003-V1/)
