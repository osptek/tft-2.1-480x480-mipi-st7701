...
本仓库收录 **2.1 寸 480×480 TFT（MIPI · ST7701）** 显示模组资料。

**根目录 README 为导航页**。下表可快速浏览各版本；点击「完整资料」进入 `versions/` 下对应**料号文件夹**（产品页、规格书、示例均在该目录内）。

规格标识（仓库名）：`2.1-tft-480x480-mipi-st7701`
...
| 版本 | 宣传图 | 简介 | 完整资料 |
| ---- | ------ | ---- | -------- |
| YDP210H003-V1 | <img alt="YDP210H003-V1" src="./versions/YDP210H003-V1/images/product.png" width="120" /> | [简介](#ydp210h003-v1) | [完整资料](./versions/YDP210H003-V1/) |
...
**说明：** IPS；带电容触摸（I2C；触摸 IC 规格书未标明）。

完整产品页、规格书与示例：[versions/YDP210H003-V1/](./versions/YDP210H003-V1/)
